...
class LuaGraphicsExtensions extends BaseLuaExtension {
  ...
  async initialize(luaState) {
    ...
    this.registerGraphicsFunctions();
    
    console.log('[LuaGraphicsExtensions] Graphics extension initialized');
  }

  /**
   * Register graphics functions with Lua state
   */
  registerGraphicsFunctions() {
    ...
    // Register individual functions under Graphics namespace
    this.luaState.set('Graphics.ClearScreen', this.clearScreen.bind(this));
    this.luaState.set('Graphics.BlitTexture', this.blitTexture.bind(this));
    this.luaState.set('Graphics.BlitTexturedQuad', this.blitTexturedQuad.bind(this));
    this.luaState.set('Graphics.LoadTexture', this.loadTexture.bind(this));
    this.luaState.set('Graphics.SetActiveTexture', this.setActiveTexture.bind(this));
    this.luaState.set('Graphics.GetTextureInfo', this.getTextureInfo.bind(this));
    this.luaState.set('Graphics.LoadPalette', this.loadPalette.bind(this));
    this.luaState.set('Graphics.SetPaletteOffset', this.setPaletteOffset.bind(this));
    this.luaState.set('Graphics.GetPaletteInfo', this.getPaletteInfo.bind(this));
    this.luaState.set('Graphics.SetColorKey', this.setColorKey.bind(this));
    this.luaState.set('Graphics.SetTextureFiltering', this.setTextureFiltering.bind(this));
    this.luaState.set('Graphics.SetViewport', this.setViewport.bind(this));
    this.luaState.set('Graphics.SetTextureMapping', this.setTextureMapping.bind(this));
    this.luaState.set('Graphics.EnableDave2DMapping', this.enableDave2DMapping.bind(this));

    // Also register functions at global level for backwards compatibility
    this.luaState.set('ClearScreen', this.clearScreen.bind(this));
    this.luaState.set('BlitTexture', this.blitTexture.bind(this));
    this.luaState.set('LoadTexture', this.loadTexture.bind(this));
    this.luaState.set('SetActiveTexture', this.setActiveTexture.bind(this));
    this.luaState.set('LoadPalette', this.loadPalette.bind(this));
    this.luaState.set('SetPaletteOffset', this.setPaletteOffset.bind(this));
    this.luaState.set('SetColorKey', this.setColorKey.bind(this));
    this.luaState.set('SetTextureFiltering', this.setTextureFiltering.bind(this));
  }
