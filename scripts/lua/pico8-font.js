...
(function registerPico8Font(root) {
  ...
  // DEVIATIONS.
  //
  // The six button prompts (0x83 down, 0x8b left, 0x8e O, 0x91 right,
  // 0x94 up, 0x97 X) are keycaps, not bare symbols: PICO-8 draws them as a
  // filled 7x5 pad with rounded corners and the symbol knocked out of the
  // middle, which is why a cart can sit one inline with text and have it read
  // as a button. They share this frame
  //
  //     .#####.
  //     ##...##
  //     ##...##
  ...
  //     .#####.
  //
  // and differ only in which of the nine interior pixels stay inked. Only the
  // O button used to be drawn this way; the arrows and the X were bare
  // outlines, so galaxis.p8's title screen showed solid triangles where the
  // reference shows d-pad keycaps.
