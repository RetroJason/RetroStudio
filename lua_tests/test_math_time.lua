...
function Setup()
    ...
    print("Time.Milliseconds() =", Time.Milliseconds())
    ...
    print("Time.HoursToDegrees(false) =", Time.HoursToDegrees(false))
    print("Time.MinutesToDegrees() =", Time.MinutesToDegrees())
    print("Time.MinutesToDegrees(false) =", Time.MinutesToDegrees(false))
    print("Time.SecondsToDegrees() =", Time.SecondsToDegrees())
    print("Time.SecondsToDegrees(false) =", Time.SecondsToDegrees(false))
